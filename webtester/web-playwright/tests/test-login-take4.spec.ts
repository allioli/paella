...
test.skip('should show inventory after log in', async ({ pageWithUserLoggedIn, shopItemsPage }) => {
...
test.skip('should log out from shop', async ({ pageWithUserLoggedIn, shopItemsPage, loginPage }) => {
