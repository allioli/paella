...
expected_rover_camera_types = {
    MarsRover.CURIOSITY:    [CameraType.FHAZ, CameraType.RHAZ, CameraType.CHEMCAM, CameraType.MAST, CameraType.MAHLI, CameraType.MARDI, CameraType.NAVCAM],
...
def check_photo_cameras(element_id, element, rover_name):
    ...
    for camera in element['cameras']:
        check_photo_camera(element_id=element_id,
                           camera_name=camera, rover_name=rover_name)
